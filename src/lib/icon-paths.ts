...
export interface IconDef {
  ...
  stroke?: number;
  /** ViewBox personnalisée (défaut "0 0 24 24" — grille maison). */
  viewBox?: string;
  /** Couleur fixe de remplissage (défaut : currentColor). */
  fillColor?: string;
  paths: IconPath[];
}
 ...
 * Source : https://github.com/openfrontio/OpenFrontIO (resources/images/PlutoniumIcon.svg).
 */
